...
Iterate over text files line by line rather than reading them whole into memory, and avoid materializing lists or sets from generators unless random access or repeated traversal is needed.
