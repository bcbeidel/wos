...
|---|-----|-------|-----------|------|--------|
| 1 | https://docs.python.org/3/library/asyncio.html | asyncio — Asynchronous I/O | Python Software Foundation | 2024 | verified |
| 2 | https://realpython.com/async-io-python/ | Async IO in Python | Real Python | 2023 | verified |
