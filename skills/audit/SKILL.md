...
- **Missing AGENTS.md or CLAUDE.md:** Offer to run `/init-wos` to
  initialize. Confirm with the user before writing any files.
- **AGENTS.md missing WOS markers:** Offer to run `/init-wos` to add
...
- Use `/init-wos` to initialize missing project structure
