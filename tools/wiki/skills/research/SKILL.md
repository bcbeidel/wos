...
references:
  ...
  - references/gather-and-extract.md
  - references/verify-sources.md
  - references/evaluate-sources-sift.md
  - references/challenge.md
  - references/synthesize.md
  - references/self-verify-claims.md
  - references/citation-reverify.md
